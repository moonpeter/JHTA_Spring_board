    ...
    <form action="list" method="get">
        <div class="input-group">
            <select name="search_field" id="viewcount">
                ...
                <option value="A">나이</option>
                <option value="G">성별</option>
                <option value="IN">아이디 또는 이름</option>
                <option value="IA">아이디 또는 나이</option>
                <option value="IG">아이디 또는 성별</option>
                <option value="INA">아이디 또는 이름 또는 나이</option>
            </select>
        ...
        <table class="table table-striped">
            ...
            <c:forEach var="m" items="${memberlist}">
                <tr>
                    ...
                    <td>${m.name}</td>
                    <td><a href="delete?id=${m.id}" style="color: red">삭제</a></td>
                </tr>
            </c:forEach>
            </tbody>
        </table>
