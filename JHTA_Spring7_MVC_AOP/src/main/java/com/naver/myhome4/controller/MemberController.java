...
public class MemberController {
	...
	public String joinProcess(Member2 member, RedirectAttributes rattr, Model model, HttpServletRequest request)
			throws Exception {
	...
	public ModelAndView memberUpdate(HttpSession session, ModelAndView mv) {
		...
		if (id == null) {
			...
			Member2 memberdata = memberservice.member_info(id);
	...
	public String updateProcess(Member2 member, Model model, HttpServletRequest request, RedirectAttributes rattr) {
