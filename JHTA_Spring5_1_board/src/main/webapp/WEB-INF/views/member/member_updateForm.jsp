...
<form action="updateProcess" name="joinform" method="post" enctype="multipart/form-data">
    <h3>회원 정보 수정</h3>
    <hr>
    <b>아이디</b>
    <input type="text" name="id" value="${memberdata.id}" readonly>

    <b>비밀번호</b>
    <input type="password" name="pass" value="${memberdata.password}" readonly>

    <b>이름</b>
    <input type="text" name="name" required value="${memberdata.name}">

    <b>나이</b>
    <input type="text" name="age" required value="${memberdata.age}">
    ...
    <b>이메일 주소</b>
    <input type="text" name="email" required value="${memberdata.email}">
...
<script>
    //성별 체크해주는 부분
    $("input[value='${memberdata.gender}']").prop('checked',true);
